  ...
  const filtered = useMemo(() => {
    return vacancies.filter((v) => {
      ...
      if (statusFilter === 'closing' ) {
        const daysLeft = (new Date(v.closingDate).getTime() - Date.now()) / (1000 * 60 * 60 * 24);
        if (daysLeft > 7 || daysLeft < 0) return false;
      }
      return true;
    });
  }, [vacancies, search, companyFilter, statusFilter]);
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              This action cannot be undone. All applications linked to this vacancy
              will have their reference removed.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
        ...
        <div className="space-y-5 px-6 py-5">
          ...
          <section className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div>
                <Label className="mb-1.5 block">Salary Range</Label>
                <Input
